...
class HooverEntityApplicationTests {
	...
	public void test_Input_From_Example() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/getPatchesCleanedNumber")
				...
				.andExpect(content().string("{\"coords\":[1,3],\"patches\":1}"));
	}
	...
	public void test_Patch_At_The_End_Of_Vacuum() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/getPatchesCleanedNumber")
				...
				.content(requestJson)
				.accept(MediaType.APPLICATION_JSON))
				.andExpect(content().string("{\"coords\":[1,2],\"patches\":1}"));
	}
	...
	public void test_Cleaned_No_Patches() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/getPatchesCleanedNumber")
				...
				.content(requestJson)
				.accept(MediaType.APPLICATION_JSON))
				.andExpect(content().string("{\"coords\":[1,1],\"patches\":0}"));
	}
	...
	public void test_Cleaned_All_Patches() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/getPatchesCleanedNumber")
				...
				.content(requestJson)
				.accept(MediaType.APPLICATION_JSON))
				.andExpect(content().string("{\"coords\":[1,4],\"patches\":3}"));
	}
	@Test
	public void test_Cleaned_Two_Patches() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/getPatchesCleanedNumber")
				...
				.content(requestJson)
				.accept(MediaType.APPLICATION_JSON))
				.andExpect(content().string("{\"coords\":[1,3],\"patches\":2}"));
	}
	...
	public void test_Error_Patches_Not_Within_Coordinates() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/getPatchesCleanedNumber")
				...
				.content(requestJson)
				.accept(MediaType.APPLICATION_JSON))
				.andExpect(content().string("{\"errors\":[\"Value for spots coordinates are not within room coordinates\"]}"));
	}
	@Test
	public void test_Error_Coordinates_Are_Not_Valid() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/getPatchesCleanedNumber")
				...
				.content(requestJson)
				.accept(MediaType.APPLICATION_JSON))
				.andExpect(content().string("{\"errors\":[\"Value for coordinates should be N/W/E/S\"]}"));
	}
	...
	public void test_Error_Value_For_Vacuum_Coordinates_Not_Within_Room() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/getPatchesCleanedNumber")
				...
				.content(requestJson)
				.accept(MediaType.APPLICATION_JSON))
				.andExpect(content().string("{\"errors\":[\"Value for vacuum coordinates are not within room coordinates\"]}"));
	}
